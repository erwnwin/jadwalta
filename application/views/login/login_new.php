...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>public/assets/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>public/assets/toastr/toastr.min.css">
    ...
    <div class="login-container">
        <div class="svg-container">
            ...
            <svg width="100" height="100" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" class="svg7">
                <polygon points="30,20 80,75 10,85" fill="#337951" fill-opacity="0.15" />
            </svg>
        </div>
        ...
        <div class="login-form-container">
            <div class="login-form">
                ...
                <a href="<?= base_url('home') ?>" class="lupa-password">Home Page</a>
            </div>
        </div>
    </div>
</body>
